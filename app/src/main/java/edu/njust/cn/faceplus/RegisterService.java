...
public class RegisterService {
    public static String registerByPost(String id, String password,String telnumber,String name) {
        ...
        try {
            ...
            String sendData = "&passwordd=" + URLEncoder.encode(password, "UTF-8")+ "&id=" + URLEncoder.encode(id, "UTF-8")+"&telnumber="+URLEncoder.encode(telnumber,"UTF-8")+"&name="+URLEncoder.encode(name,"UTF-8");
